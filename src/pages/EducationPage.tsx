...
const EducationPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Every Nymara diamond is independently graded and certified by world-renowned institutes such as IGI, ensuring complete authenticity and trust using the same 4C criteria as natural diamonds.",
    },
    {
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-6">
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    same rigorous standards as natural stones by IGI.
                  </p>
            ...
            <div className="bg-gradient-to-r from-[#9a8457] to-[#b39968] rounded-3xl p-8 text-center text-white shadow-xl">
              ...
              <div className="flex flex-wrap justify-center gap-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/30">
                  ...
                  <div className="text-white font-medium">+44 7867089659</div>
