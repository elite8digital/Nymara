...
// import { Minus, Plus, X, Heart, ShoppingBag, Truck, Shield, CreditCard, Check, Gift, Tag, ArrowLeft, Copy, Building2, User, Upload, FileText } from 'lucide-react';
...
//       return;
//     }
//     // Here you would typically upload the receipt to your server
...
//               <div className="bg-white/40 rounded-xl shadow-lg p-6 sm:p-8 text-gray-900 ">
//                 <div className="flex items-center justify-between mb-6">
//                   <h3 className="text-lg sm:text-xl font-semibold">Bank Transfer Details</h3>
...
//                         <div className="text-xs sm:text-sm opacity-80 mb-1">Account Holder</div>
//                         <div className="font-semibold text-base sm:text-lg">NYMARA JEWELS</div>
//                       </div>
//                       <button
//                         onClick={() => copyToClipboard('NYMARA JEWELS', 'holder')}
...
//                     <div className="flex items-center justify-between">
//                       <div className="flex-1">
//                         <div className="text-xs sm:text-sm opacity-80 mb-1">Account Number</div>
//                         <div className="font-mono font-semibold text-base sm:text-lg">5020 0104 8630 01</div>
//                       </div>
//                       <button
//                         onClick={() => copyToClipboard('50200104863001', 'account')}
//                         className="ml-2 p-2 hover:bg-white/20 rounded-lg transition-colors"
//                       >
...
//                       <div className="flex items-center justify-between">
//                         <div className="flex-1">
//                           <div className="text-xs sm:text-sm opacity-80 mb-1">Account Type</div>
//                           <div className="font-semibold text-sm sm:text-base">Current Account</div>
//                         </div>
//                       </div>
//                     </div>
...
//                       <div className="flex items-center justify-between">
//                         <div className="flex-1">
//                           <div className="text-xs sm:text-sm opacity-80 mb-1">Bank</div>
//                           <div className="font-semibold text-sm sm:text-base">HDFC Bank</div>
//                         </div>
//                       </div>
//                     </div>
//                   </div>
...
//                     <div className="flex items-center justify-between">
//                       <div className="flex-1">
//                         <div className="text-xs sm:text-sm opacity-80 mb-1">IFSC Code</div>
//                         <div className="font-mono font-semibold text-base sm:text-lg">HDFC0001026</div>
//                       </div>
//                       <button
//                         onClick={() => copyToClipboard('HDFC0001026', 'ifsc')}
//                         className="ml-2 p-2 hover:bg-white/20 rounded-lg transition-colors"
//                       >
...
//                     <div className="flex items-center justify-between">
//                       <div className="flex-1">
//                         <div className="text-xs sm:text-sm opacity-80 mb-1">Branch</div>
//                         <div className="font-semibold text-sm sm:text-base">NANPURA</div>
//                       </div>
//                     </div>
//                   </div>
//                 </div>
...
//                   <div>
//                     <h4 className="font-medium text-blue-900 text-sm sm:text-base mb-1">Payment Instructions</h4>
//                     <ul className="text-xs sm:text-sm text-blue-800 space-y-1">
//                       <li>• Transfer the exact order amount to the account above</li>
//                       <li>• Upload your payment receipt below</li>
//                       <li>• After uploading, click "Place Order"</li>
...
//                     Please upload your bank transfer receipt or transaction screenshot
//                   </p>
...
//                           className="hidden"
//                         />
//                         <span className="cursor-pointer bg-[#9a8457] text-white px-6 py-3 rounded-lg hover:bg-[#8a7547] transition-colors text-sm sm:text-base inline-flex items-center space-x-2">
...
//                         </button>
//                       </div>
//                       <div className="flex items-center space-x-2 mt-3 text-green-700">
//                         <Check className="w-4 h-4" />
//                         <span className="text-xs sm:text-sm">Receipt uploaded successfully</span>
//                       </div>
//                     </div>
//                   )}
//                 </div>
...
//                   className={`flex-1 py-3 px-6 rounded-lg font-medium transition-colors text-sm sm:text-base flex items-center justify-center space-x-2 ${
//                     paymentReceipt
//                       ? 'bg-[#9a8457] text-white hover:bg-[#8a7547] cursor-pointer'
...
//               {!paymentReceipt && (
//                 <p className="text-xs sm:text-sm text-red-600 text-center mt-3">
//                   ⚠️ Please upload your payment receipt to place the order
//                 </p>
//               )}
//             </div>
