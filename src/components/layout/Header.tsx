          ...
          <div className="mx-auto px-4 lg:px-6">
              ...
              <div className="flex items-center">
                ...
                >
                  <img
                    src={logomain}
                    alt="Nymara Jewels"
                    className={`transition-all duration-300 h-40 -mt-8 -mb-10 md:-mb-7 md:pl-[88px]`}
                  />
                </button>
              </div>
            ...
            <div className="hidden lg:flex justify-center items-center space-x-12 pt-4 mt-2 border-t border-gray-100">
              ...
              <div className="vrai-dropdown-container">
                ...
                >
                  <span className="text-sm">Craft My Vision</span>
                </button>
              </div>
              ...
              <div className="vrai-dropdown-container">
                <button
                  className="flex items-center space-x-1 vrai-nav-link py-3"
                  onClick={() => handleNavigation("rings", { type: "navigate", target: "/rings" })}
                >
                      ...
                      {openDropdown === `mobile-${category}` && (
                        <div className="bg-gray-50">
                          ...
                          <div>
                            <button
                              onClick={(e) =>
                                toggleNestedDropdown("mobile-aboutUs", e)
                              }
                          ...
                          <div>
                            <button
                              onClick={(e) =>
                                toggleNestedDropdown("mobile-diamondGuide", e)
                              }
                              className="flex justify-between items-center w-full text-left py-3 px-8 font-medium text-gray-800"
                            >
                              <span>Diamond Guide</span>
                            ...
                            {openNestedDropdown === "mobile-diamondGuide" && (
                              <div className="bg-gray-100">
                                {educationSections.diamondGuide.map(
                                  (item, index) => (
                                    <button
                                      key={index}
                                      onClick={() =>
                          ...
                          <div>
                            <button
                              onClick={(e) =>
                                toggleNestedDropdown("mobile-jewelryGuide", e)
                              }
                              className="flex justify-between items-center w-full text-left py-3 px-8 font-medium text-gray-800"
                            >
                              <span>Jewelry Guide</span>
                            ...
                            {openNestedDropdown === "mobile-jewelryGuide" && (
                              <div className="bg-gray-100">
                                {educationSections.jewelryGuide.map(
                                  (item, index) => (
                                    <button
                                      key={index}
                                      onClick={() =>
