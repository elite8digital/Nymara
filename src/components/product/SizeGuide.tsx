...
const SizeGuide: React.FC<SizeGuideProps> = ({ isOpen, onClose, productType }) => {
  ...
  const [activeGuide, setActiveGuide] = useState<GuideType>(getInitialGuideType());
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="flex justify-between items-center px-6 py-5 border-b border-gray-200">
          <h3 className="text-2xl font-semibold text-gray-900">{currentGuide.title}</h3>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto px-6 py-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              {activeGuide === 'bangles' && Array.isArray(currentGuide.images) ? (
