...
const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Main Filter Bar */}
    <div className="flex flex-col md:flex-col lg:flex-row lg:items-center lg:justify-between gap-4 bg-white/60 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/20">

        {/* Search and Filters */}
       <div className="flex flex-wrap items-center gap-3 w-full lg:flex-1">

          {/* Search */}
         <div className="relative flex-1 min-w-[180px] sm:min-w-[240px] max-w-full">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 sm:gap-4 lg:justify-end w-full lg:w-auto">
          ...
          <select
           ...
           className="px-3 py-2 border border-gray-200 bg-white/80 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#9a8457] w-full sm:w-auto"
